...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val loginSingleton: LoginSingleton by lazy { LoginSingleton.getInstance(applicationContext) }
        val loginDB: LoginDB by lazy { loginSingleton.loginDB }
        ...
        btnLogin.setOnClickListener {
            ...
            if (loginDB.isLoginValid(username, password)) {
